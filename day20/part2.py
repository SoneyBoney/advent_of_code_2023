...
with open(filename) as f:
    ...
    for i in range(1,4100):
        ...
        while Q:
            ...
            if Pulse.High in G['nc'].memory.values():
                for k,v in G['nc'].memory.items():
                    if v == Pulse.High and k not in nc_counts:
                        nc_counts[k] = i

    print(nc_counts)
    print(math.lcm(*nc_counts.values()))
